...
judge.create_board()
square_size = 100
board_width = judge._board._columns * square_size
board_height = judge._board._rows * square_size
...
def draw_board():
    for row in range(judge._board._rows):
        for col in range(judge._board._columns):
